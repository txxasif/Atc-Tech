// class="absolute -top-6 -start-8 h-16 w-16 text-gray-100 dark:text-gray-700"
import Image from "next/image";
import { Reveal, RevealFromLeft, RevealFromRight } from "./shared/reveal";
          ...
          <div className="relative w-full ">
            <p className="w-full md:bold-16 md:regular-20  ">
              <em>
                ...
                engineers, trained in international quality standards, ensure
                flawless execution and uncompromising data security. We empower
                organizations through technology and strive for global
                leadership, fueled by stakeholder support and a commitment to
                innovation.
              </em>
            </p>
          </div>
