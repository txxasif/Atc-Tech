...
export function CeoQuote() {
  return (
    <figure class="mx-auto text-center">
      <svg
        class="w-10 h-10 mx-auto mb-3 mt-20 text-gray-400 dark:text-gray-600"
        aria-hidden="true"
      ...
      <figcaption class="flex items-center justify-center mt-6 space-x-3 rtl:space-x-reverse">
        <div class="flex items-center divide-x-2 rtl:divide-x-reverse divide-gray-500 dark:divide-gray-700 mb-20">
...
<svg
  className=" relative border-s-4 ps-4 sm:ps-6 dark:border-gray-700"
  width="16"
  height="16"
  viewBox="0 0 16 16"
  fill="none"
...
<div className="relative w-full text-white ">
  <p className="text-gray-800 sm:text-xl dark:text-white">
    <em>
      Building on five years of successful software development, ATC
      confidently approaches future needs. Our highly skilled engineers,
      trained in international quality standards, ensure flawless
      execution and uncompromising data security. We empower
      organizations through technology and strive for global leadership,
      fueled by stakeholder support and a commitment to innovation.
    </em>
  </p>
</div>
<svg
  className=" absolute bottom-10 right-20 h-16 w-16  rotate-180 text-gray-10"
  width="16"
  height="16"
  viewBox="0 0 16 16"
  fill="none"
...
<footer className="mt-6">
  <div className="flex items-center">
    <div className="md:ms-4">
      ...
      <div className="text-lg text-white">CEO</div>
    </div>
  </div>
</footer>
</blockquote> */
